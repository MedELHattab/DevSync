...
<div class="p-16">
  ...
  <table class="table-auto w-full border-collapse border border-gray-300 rounded-lg overflow-hidden">
    ...
    %>
    <tr class="bg-white">
      <td class="border border-gray-300 px-4 py-2 bg-blue-100 rounded-l-lg"><%= user.getId() %></td> <!-- Rounded corner and different background for ID -->
      ...
      <td class="border border-gray-300 px-4 py-2 rounded-r-lg"> <!-- Rounded corner for the last column -->
